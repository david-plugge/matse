...
const rawLinks: Link[] = [
	...
	{
		label: 'Campus Office',
		description: 'Planung und Verwaltung von verschiedenen Vorlesungs- und Veranstaltungsdaten',
...
export const links = rawLinks.map((l) => ({
	...l,
	searchString: [l.label, l.description, ...l.tags].filter(Boolean).join(' ').toLowerCase()
}));
